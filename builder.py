...
from Utils.Path import (
    ...
    # 图片处理相关路径
    CAMPUS_PROCESSED_EXTRACTED_IMAGES, CAMPUS_EXTRACTED_IMAGES_JSON, CAMPUS_IMAGES_PATH,
    FITNESS_PROCESSED_EXTRACTED_IMAGES, FITNESS_EXTRACTED_IMAGES_JSON, FITNESS_IMAGES_PATH,
    PAPER_PROCESSED_EXTRACTED_IMAGES, PAPER_EXTRACTED_IMAGES_JSON, PAPER_IMAGES_PATH,
    PSYCHOLOGY_PROCESSED_EXTRACTED_IMAGES, PSYCHOLOGY_EXTRACTED_IMAGES_JSON, PSYCHOLOGY_IMAGES_PATH
)
